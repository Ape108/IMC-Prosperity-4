...
class MarketMakingStrategy(Strategy):
    ...
    def act(self, state: TradingState) -> None:
        ...
        # --- THE FIX: Cubic Inventory Skew ---
        # Replaces linear skew with a cubic function to protect against trending markets.
        # This increases the skew pressure exponentially as position approaches limits.
        skew_factor = 1.0  # Constant to tune aggressiveness
        inventory_ratio = position / self.limit
        skew = (inventory_ratio ** 3) * skew_factor
...
class VoucherStrategy(Strategy):
    ...
    def act(self, state: TradingState) -> None:
        ...
        bid_price = floor(skewed_theo - 0.5)
        ask_price = ceil(skewed_theo + 0.5)
