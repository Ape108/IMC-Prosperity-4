...
class PepperRootStrategy(StatefulStrategy[list[float]]):
    """
    Buy & Hold with SMA Reversal Protection for INTARIAN_PEPPER_ROOT.
    
    Accumulates to the max long limit as long as the current price is 
    above the Simple Moving Average. If the price rug-pulls and drops 
